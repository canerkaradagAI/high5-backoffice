...
const updateCustomerSchema = z.object({
  ...
  movedToPoolAt: z.string().datetime().optional().nullable(),
  ...
  try {
    ...
    const updatedCustomer = await prisma.customer.update({
      ...
      data: {
        ...
        assignedConsultantId: validatedData.assignedConsultantId,
        movedToPoolAt: validatedData.movedToPoolAt ? new Date(validatedData.movedToPoolAt) : null,
